...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad: @producto.cantidad, descriptcion: @producto.descriptcion, nombre: @producto.nombre }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { cantidad: @producto.cantidad, descriptcion: @producto.descriptcion, nombre: @producto.nombre }
    assert_redirected_to producto_path(assigns(:producto))
  end
